...
export const metadata = {
  title: "Our Clinics in Gurugram | Sector 69 & 77",
  description:
  ...
  openGraph: {
    ...
    description:
      "Two fully equipped dental clinics in Gurugram — Sector 69 and 77 — open all seven days.",
    url: "/clinics",
    type: "website",
...
const clinicFaqs = [
  {
    ...
    a: "Both clinics — Sector 69 and Sector 77 — are open Monday to Sunday from 11:00 AM to 7:30 PM. We recommend calling ahead on +91 97118 11272 to confirm a slot.",
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        subtitle={`Two fully equipped clinics — Sector 69 and 77 — open ${site.hours}. Same specialists, same standards, shared records.`}
