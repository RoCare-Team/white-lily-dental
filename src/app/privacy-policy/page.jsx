...
const buildSections = (site) => [
  ...
  },
  {
    ...
    paragraphs: [
      "Clinical information is accessible to the treating dentists and clinical staff at both of our Gurugram clinics so that you can be seen at either location.",
